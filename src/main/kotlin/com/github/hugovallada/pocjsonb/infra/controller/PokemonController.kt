...
class PokemonController(
    ...
    fun salvar() {
        ...
        val p = Pokemon(
            name = "Charmander",
            type = "Fire",
            powers = om.writeValueAsString(powers),
            evolutions = om.writeValueAsString(evolutions),
            trainer = om.writeValueAsString(trainer)
        )
